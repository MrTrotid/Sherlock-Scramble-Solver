...
grid = [
    ["M", "R", "G", "E", "O", "A", "U", "N", "G", "W", "R", "X", "L", "C", "Z"],
    ["Q", "V", "I", "S", "T", "A", "S", "X", "M", "H", "Y", "M", "V", "Z", "S"],
    ["U", "J", "E", "Q", "R", "A", "O", "X", "B", "T", "J", "Z", "X", "R", "G"],
    ["A", "H", "O", "P", "V", "W", "Z", "R", "I", "I", "Q", "N", "O", "Z", "S"],
    ["L", "E", "D", "X", "A", "C", "E", "N", "P", "B", "Q", "S", "G", "N", "T"],
    ["I", "G", "X", "H", "A", "N", "U", "B", "Y", "Y", "S", "W", "O", "O", "P"],
    ["F", "R", "F", "A", "C", "M", "O", "M", "T", "E", "S", "I", "Y", "R", "N"],
    ["I", "A", "R", "I", "M", "W", "O", "R", "F", "L", "T", "F", "E", "L", "L"],
    ["C", "D", "D", "O", "R", "S", "M", "O", "A", "A", "U", "P", "N", "R", "G"],
    ["A", "E", "C", "C", "X", "Y", "R", "M", "C", "M", "A", "O", "G", "L", "K"],
    ["T", "V", "T", "Y", "G", "P", "D", "I", "U", "P", "A", "Y", "G", "S", "K"],
    ["I", "X", "Y", "I", "F", "Z", "L", "U", "T", "T", "Q", "L", "Z", "Q", "M"],
    ["O", "G", "N", "I", "C", "B", "Q", "S", "U", "N", "E", "S", "T", "I", "F"],
    ["N", "X", "L", "R", "U", "Z", "A", "S", "T", "L", "U", "S", "E", "R", "X"],
    ["S", "X", "T", "P", "A", "P", "Q", "Y", "S", "Q", "H", "V", "D", "W", "V"]
]
...
def main():
    ...
    words_from_image = [
        "COMMUNITY", "EXAMS", "GRADE", "PANORAMA", "PASTPAPER",
        "PROFESSORS", "PUBLICATIONS", "QUALIFICATIONS", "RESULTS", "VISTAS"
    ]
